...
echarts.use(
    [DatasetComponent, ToolboxComponent, TooltipComponent, GridComponent, LegendComponent, ScatterChart, CanvasRenderer]
);
export default class LineChart extends Component {
  ...
  componentDidMount(){
    ...
    axios.get(ROOT_PATH + '/data/asset/data/life-expectancy-table.json').then(res=>{
        var sizeValue = '57%';
        var symbolSize = 2.5;
        option = {
            legend: {},
    ...
    render() {
        return (
            <div id='main' style={{height:'800px'}}>
                {/* <Card >
                <ReactEcharts style={{height:'500px'}}  ></ReactEcharts>
                </Card> */}
            </div>
        )
    }
